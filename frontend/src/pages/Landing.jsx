            ...
            {dummyFeaturedSwaps.map((swap, index) => (
              ...
              >
                ...
                <div className="h-48 overflow-hidden relative">
                  ...
                  />
                  <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-green-700 flex items-center gap-1 shadow-sm">
                    <Leaf className="w-3 h-3" /> {swap.ecoScore} kg saved
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-1">{swap.productName}</h3>
                  <p className="text-sm text-gray-600 mb-4">Crafted by <span className="text-eco font-medium">{swap.artisanName}</span></p>
                  
                  <button className="w-full bg-gray-50 text-gray-700 py-2.5 rounded-xl text-sm font-bold border border-gray-200 group-hover:bg-eco group-hover:text-white group-hover:border-eco transition-all flex justify-center items-center gap-2">
