...
import { useAuth, profileFirstName, greetingPeriod } from '../context/AuthContext';
      ...
      <div className="grid gap-4" style={{ gridTemplateColumns: '2fr 1fr' }}>
        ...
        <div className="bg-s1 border border-[rgba(255,255,255,0.06)] rounded-2xl p-6">
          ...
          <div className="flex flex-col items-center justify-center min-h-[180px] text-center px-2">
            <p className="text-sm text-muted leading-relaxed">Categories will appear here once you have listing activity.</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-4" style={{ gridTemplateColumns: '1fr 1fr 340px' }}>
        <div className="bg-s1 border border-[rgba(255,255,255,0.06)] rounded-2xl p-6">
          ...
          <div className="flex flex-col items-center justify-center py-10 text-center px-2">
            ...
            <p className="text-xs text-muted leading-relaxed">Messages, sales, and reviews will show up as you use UniThrift.</p>
          </div>
        </div>
        ...
        >
          ...
          <button
            type="button"
            onClick={() => nav('/carbon')}
            className="w-full text-left text-sm font-semibold text-green-eco bg-green-muted border border-[rgba(61,255,110,0.2)] rounded-xl px-4 py-3 hover:bg-[rgba(61,255,110,0.12)] transition-all"
          >
            Open full carbon tracker →
          </button>
