...
const Chats = () => {
  ...
  const isArtisan = userInfo.role === 'artisan'; // 👇 Role check karo
  ...
  // 👇 Ye logic decide karega ki chat mein kiska naam dikhana hai
              ...
              >
                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  <p className="text-xs text-gray-500 flex items-center gap-1 mt-1 truncate">
                    <User className="w-3 h-3" /> {getDisplayName(order)} {/* 👈 Smart Name Display */}
                  </p>
                </div>
              </div>
            ))
            ...
            <div className="p-4 border-b border-gray-200 flex items-center gap-4 bg-white shadow-sm z-10">
              ...
              <div>
                ...
                <p className="text-xs text-green-600 font-medium flex items-center gap-1">
                  <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span> Chatting with {getDisplayName(selectedSwap)} {/* 👈 Smart Name Display */}
                </p>
              </div>
            </div>
